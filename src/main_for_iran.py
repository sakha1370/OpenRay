...
# Set sources to Iran-specific list
C.SOURCES_FILE = os.path.join(C.REPO_ROOT, 'sources_iran.txt')

# Now import the rest of the pipeline after patching constants
from .common import log, progress, sha1_hex  # noqa: E402
...
from .geo import _build_country_counters, _country_flag  # noqa: E402
from .grouping import regroup_available_by_country, write_grouped_outputs  # noqa: E402
...
from .net import (  # noqa: E402
    _get_country_code_for_host,
    fetch_url,
    ping_host,
    connect_host_port,
    quick_protocol_probe,
    validate_with_v2ray_core,
)
